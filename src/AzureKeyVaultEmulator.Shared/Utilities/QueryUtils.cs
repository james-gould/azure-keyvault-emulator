...
{
    /// <summary>
    /// Returns a collection of entities representing the initial version for each unique persisted name in the set.
    /// </summary>
    /// <remarks>The initial version is determined by selecting the entity with the earliest 'Updated'
    /// timestamp in its attributes for each unique persisted name. This method is typically used to identify the
    /// original state of entities that may have multiple versions.</remarks>
