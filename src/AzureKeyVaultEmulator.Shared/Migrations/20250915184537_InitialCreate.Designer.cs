...
namespace AzureKeyVaultEmulator.Shared.Migrations
{
    ...
    [Migration("20250915184537_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AzureKeyVaultEmulator.Shared.Models.Certificates.CertificateBundle", b =>
                {
                    b.OwnsOne("AzureKeyVaultEmulator.Shared.Models.Certificates.CertificateAttributesModel", "Attributes", b1 =>
                        {
            ...
            modelBuilder.Entity("AzureKeyVaultEmulator.Shared.Models.Certificates.CertificatePolicy", b =>
                {
                    ...
                    b.OwnsOne("AzureKeyVaultEmulator.Shared.Models.Certificates.CertificateAttributesModel", "CertificateAttributes", b1 =>
                        {
                            b1.Property<Guid>("PersistedId")
                                .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AzureKeyVaultEmulator.Shared.Models.Keys.KeyBundle", b =>
                {
                    b.OwnsOne("AzureKeyVaultEmulator.Shared.Models.Keys.JsonWebKeyModel", "Key", b1 =>
                        {
                            b1.Property<Guid>("PersistedId")
                                .HasColumnType("TEXT");
                    ...
                    b.OwnsOne("AzureKeyVaultEmulator.Shared.Models.Keys.KeyAttributesModel", "Attributes", b1 =>
                        {
                            b1.Property<Guid>("PersistedId")
                                .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AzureKeyVaultEmulator.Shared.Models.Secrets.SecretBundle", b =>
                {
                    b.OwnsOne("AzureKeyVaultEmulator.Shared.Models.Secrets.SecretAttributesModel", "Attributes", b1 =>
                        {
                            b1.Property<Guid>("PersistedId")
                                .HasColumnType("TEXT");
